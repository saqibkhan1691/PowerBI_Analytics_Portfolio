...
Alt + A + T  = it is shortcut for quickly enable filters in your dataset
and we use this shortcut for check missing/wrong/duplicate value in dataset for data transformation
